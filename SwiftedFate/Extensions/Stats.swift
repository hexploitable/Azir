...
public extension SwiftedFate {
  ...
  public final class stats {
     ...
     */
    public func getRankedStats(region: Region? = nil, bySummonerId summonerId: String, completion: (NSDictionary?, Error?) -> Void) {
     ...
     */
    public func getStatsSummary(region: Region? = nil, bySummonerId summonerId: String, completion: (NSDictionary?, Error?) -> Void) {
      let region = (region ?? parent.region)!
