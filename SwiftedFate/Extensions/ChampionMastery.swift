...
public extension SwiftedFate {
  ...
  public final class championMastery {
     ...
     */
    public func getChampion(region: Region? = nil, platform: Region.Platform? = nil, bySummonerId summonerId: String, byChampionId championId: String, completion: (NSDictionary?, Error?) -> Void) {
     ...
     */
    public func getChampions(region: Region? = nil, platform: Region.Platform? = nil, bySummonerId summonerId: String, completion: (NSDictionary?, Error?) -> Void) {
      let regionData = (region: (region ?? parent.region)!, platform: (platform ?? parent.platform)!)
     ...
     */
    public func getScore(region: Region? = nil, platform: Region.Platform? = nil, bySummonerId summonerId: String, completion: (NSDictionary?, Error?) -> Void) {
      let regionData = (region: (region ?? parent.region)!, platform: (platform ?? parent.platform)!)
     ...
     */
    public func getTopChampions(region: Region? = nil, platform: Region.Platform? = nil, bySummonerId summonerId: String, count: Int = 3, completion: (NSDictionary?, Error?) -> Void) {
      let regionData = (region: (region ?? parent.region)!, platform: (platform ?? parent.platform)!)
