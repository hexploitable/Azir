...
public extension SwiftedFate {
  ...
  public final class championMastery {
     ...
     */
    public func getChampionMasteryChampion(region region: Region? = nil, platform: Region.Platform? = nil, bySummonerId summonerId: String, byChampionId championId: String, completion: (NSDictionary?, Error?) -> Void) {
     ...
     */
    public func getChampionMasteryChampions(region region: Region? = nil, platform: Region.Platform? = nil, bySummonerId summonerId: String, completion: (NSDictionary?, Error?) -> Void) {
      let regionData = (region: (region ?? parent.region)!, platform: (platform ?? parent.platform)!)
     ...
     */
    public func getChampionMasteryScore(region region: Region? = nil, platform: Region.Platform? = nil, bySummonerId summonerId: String, completion: (NSDictionary?, Error?) -> Void) {
      let regionData = (region: (region ?? parent.region)!, platform: (platform ?? parent.platform)!)
     ...
     */
    public func getChampionMasteryTopChampions(region region: Region? = nil, platform: Region.Platform? = nil, bySummonerId summonerId: String, count: Int = 3, completion: (NSDictionary?, Error?) -> Void) {
      let regionData = (region: (region ?? parent.region)!, platform: (platform ?? parent.platform)!)
