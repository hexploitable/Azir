...
public extension SwiftedFate {
  ...
  public final class champion {
     ...
     */
    public func getChampions(region: Region? = nil, freeToPlay: Bool = false, completion: (NSDictionary?, Error?) -> Void) {
     ...
     */
    public func getChampion(region: Region? = nil, byId championId: String, completion: (NSDictionary?, Error?) -> Void) {
      let region = (region ?? parent.region)!
